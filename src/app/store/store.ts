...
export type InspectorTab = "frame" | "color" | "audio" | "text" | "subtitles" | "export";

export type Selection = { kind: "clip"; id: string } | { kind: "text"; id: string } | { kind: "cue"; id: string } | null;
...
export function setState(patch: Partial<EditorState> | ((prev: EditorState) => Partial<EditorState>)): void {
