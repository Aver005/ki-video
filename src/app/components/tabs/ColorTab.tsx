...
const FIELDS: { key: keyof ColorGrade; label: string; min: number; max: number }[] = [
...
export function ColorTab() {
  ...
  return (
    <div className="tab-body">
      ...
      <p className="muted">В превью видны яркость, контраст и насыщенность. Гамма, сочность и резкость — при экспорте.</p>
    </div>
  );
}
